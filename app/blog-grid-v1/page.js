                                ...
                                <div className="col-md-12">
                                    <div className="flat-tabs">
                                        <ul className="menu-tab">
                                            ...
                                            <li className={flatTabs === 2 ? "active" : ""} onClick={() => handleFlatTabs(2)}><h6 className="fs-16">Forex Pairs</h6></li>
                                            <li className={flatTabs === 3 ? "active" : ""} onClick={() => handleFlatTabs(3)}><h6 className="fs-16">Cryptocurrencies</h6></li>
                                            <li className={flatTabs === 4 ? "active" : ""} onClick={() => handleFlatTabs(4)}><h6 className="fs-16">Commodities</h6></li>
                                        </ul>
