...
export default function SellCryptoDetails() {
    ...
    const handleClick = () => {
        router.push("/wallet"); // <- la page cible
      };
                                    ...
                                    <div className="content-tab">
                                        <div className="content-inner" style={{ display: `${flatTabs === 1 ? "block" : "none"}` }}>
                                            ...
                                            <div className="main details center">
                                                ...
                                                <p>
                                                    You successfully bought 1.356 <span>BTC</span> for Xpero  !
                                                </p>
                                                <ul className="status">
                                                    <li className="top">
                                        ...
                                        <div className="content-inner" style={{ display: `${flatTabs === 2 ? "block" : "none"}` }}>
                                            ...
                                            <div className="main payment">
                                                ...
                                                <div className="group-button">
                                                    <button className="cancel btn-action-3">Tradel</button>
                                                    <button className="submit btn-action" onClick={handleClick}>Wallet</button>
                                                </div>
                                            </div>
                                        </div>
